...
<head>
    ...
    <title>Mon Profil & Paramètres - Medilink</title>
    ...
    <style>
        ...
        .profile-grid {
            display: grid;
            grid-template-columns: 1fr 1fr; /* Deux colonnes pour la structure principale */
            gap: 30px;
        }
        ...
        .emergency-card {
            ...
            background-color: #ffebee; /* Rouge très clair (Urgence) */
