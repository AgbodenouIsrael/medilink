            ...
            <div class="profile-header-card">
                ...
                <div style="flex-grow: 1;">
                    ...
                    <p style="color:#666; margin:5px 0;">{{ $pharmacie->zone->ville ?? 'Lomé' }},
                        {{ $pharmacie->zone->nom ?? 'Togo' }} • ID: {{ $pharmacie->numero_licence }}</p>
                    <span
                ...
                <button class="btn"
                    style="background: var(--primary-green); color: white; border: none; padding: 12px 20px; border-radius: 8px; font-weight: 600;">Save
                    Changes</button>
            </div>
            ...
            <div class="settings-grid">
                <div class="settings-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $pharmacie->nom_officine }}">
                    </div>
                    <div class="form-group">
                        <label>Pharmacien en charge</label>
                        <input type="text" value="{{ $pharmacie->pharmacien_titulaire }}">
                    </div>
                    <div class="form-group">
                        <label>Emplacement / Adresse</label>
                        <textarea rows="3">{{ $pharmacie->adresse_complete }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Contact </label>
                        <input type="text" value="{{ $pharmacie->telephone }}">
                    </div>
                </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="status-toggle">
                        ...
                        <label class="switch">
                            <input type="checkbox" {{ $pharmacie->accepte_ordonnances ? 'checked' : '' }}>
                    ...
                    <div class="status-toggle">
                        ...
                        <label class="switch">
                            <input type="checkbox" {{ $pharmacie->en_ligne ? 'checked' : '' }}>
                            <span class="slider"></span>
                        </label>
                    </div>
