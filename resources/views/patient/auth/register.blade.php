    ...
    <div class="container registration-container">
        ...
        <main class="card">
            ...
            <form action="{{ route('patients.store') }}" method="POST" novalidate>
                ...
                <div style="display: flex; gap: 20px;">
                    <div class="input-group" style="flex: 1;">
                        ...
                        <input type="tel" id="contact" name="contact" placeholder="+228 99 99 99 99"
                ...
                <div style="display: flex; gap: 20px;">
                    <div class="input-group" style="flex: 1;">
                        ...
                        <input type="text" id="adresse" name="adresse" placeholder="12 Rue de la Santé"
                ...
                <div class="input-group" style="margin: 15px 0;">
                    <label
                        style="display: flex; align-items: start; gap: 10px; cursor: pointer; font-weight: normal; font-size: 0.95em;">
                        <input type="checkbox" id="privacy_policy" name="privacy_policy" required disabled
                            style="width: auto; margin-top: 3px;">
                        <span>
                            Je reconnais avoir lu et j'accepte la <a href="{{ route('privacy.policy') }}"
                                target="_blank" id="privacy_link"
                                style="color: var(--color-patient); text-decoration: underline; font-weight: 600;">Politique
                ...
                <button type="submit" class="btn primary-btn"
                    style="background-color: var(--color-patient);">S'inscrire</button>
            ...
            <p style="text-align: center; margin-top: 20px; font-size: 0.9em;">
                Déjà un compte ? <a href="{{ route('connexion') }}"
                    style="color: var(--color-primary-blue); text-decoration: none;">Connectez-vous ici.</a>
            </p>
        </main>
    </div>
</body>
