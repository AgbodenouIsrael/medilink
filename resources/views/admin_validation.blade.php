...
<head>
    ...
    <title>Validation Comptes - Admin - Medilink</title>
...
<body class="dashboard-body admin-theme">
    <div class="sidebar">
        ...
        <nav class="nav-menu">
            <a href="{{ route('admin.dashboard') }}" class="nav-item"><i class="fas fa-tachometer-alt"></i> Vue
                d'ensemble</a>
            <a href="#" class="nav-item active"><i class="fas fa-check-double"></i> Validations</a>
    ...
    <div class="main-content">
        ...
        <table class="validation-table">
            ...
            <tbody>
                ...
                @if($pendingMedecins->isEmpty() && $pendingHopitaux->isEmpty())
                    <tr>
