                ...
                @foreach($pending as $medecin)
                    <div
                        ...
                        <div style="display: flex; gap: 10px;">
                            <form action="{{ route('hopital.medecin.approve', $medecin->id) }}" method="POST"
                            ...
                            <form action="{{ route('hopital.medecin.reject', $medecin->id) }}" method="POST"
                                style="display: inline;">
                                @csrf
        ...
        <div class="search-medecin-bar">
            <form action="{{ url()->current() }}" method="GET" novalidate>
                ...
                <div class="input-group">
                    <input type="text" name="q" placeholder="Rechercher par Nom, Prénom ou ID Médecin..."
            ...
            <tbody>
                @forelse($medecins as $medecin)
                    <tr>
                        ...
                        <td
                            class="medecin-status {{ $medecin->pivot->statut === 'actif' ? 'status-actif' : 'status-inactif' }}">
