...
@section('title', 'Messages - Dashboard Médecin - Medilink')
        ...
        <div class="conversation-list">
            @forelse($chats as $c)
                <div class="conversation-item {{ isset($chat) && $chat->id == $c->id ? 'active' : '' }}"
                    ...
                    <div class="avatar" style="background-color: #3498db;"><i class="fas fa-user-injured"></i></div>
                    <div class="conv-info">
        ...
        <div class="chat-window">
            @if(isset($chat))
                <div class="chat-header">
                    <h4>Discussion avec <strong>{{ $chat->patient->prenom }} {{ $chat->patient->nom }}</strong> (Patient)</h4>
                </div>
